...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  setProfileMenuList() {
    ...
    settingsMenu = [
      if (Constant.session.isUserLoggedIn() && (Constant.session.getData(SessionManager.keyLoginType) == "phone" || Constant.session.getData(SessionManager.keyLoginType) == "email"))
        {
          "icon": "password_icon",
